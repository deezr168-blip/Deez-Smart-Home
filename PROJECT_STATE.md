...
| Heading-card contrast (`themes/deez_your_name.yaml`) | Main CasaRay Upgrade | pending stamp — 2026-08-30 00:10 | `LIVE_VERIFICATION_REQUIRED` | 2026-08-30 06:10 | Closes UI-027. One theme-level `card-mod-card-heading` rule; no dashboard YAML touched. |
