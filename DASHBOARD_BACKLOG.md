...
| Missing title-card `card_mod` text-shadow on 4 of 29 title cards dashboard-wide (`bill-car-insurance`, `bill-water`, `bill-council-rates`, `bill-rego`) — added the same block already used by the other 25 | `BILL-005` | `<pending>` |
