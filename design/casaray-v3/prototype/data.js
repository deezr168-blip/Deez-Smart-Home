...
window.SCENARIOS = {
  ...
  // The snapshot Concepts A, B and C are drawn on (concepts/README.md):
  // Thursday 25/09/26 16:20. Used to compare all four concepts on the same
  // data. Values the concepts do not show keep their evening defaults.
  review: {
    'weather.forecast_home': {
      s: 'partlycloudy',
      a: {
        temperature: 17, humidity: 60,
        forecast: [
          { d: 'sun', hi: 19, lo: 9, c: 'partly' },
          { d: 'mon', hi: 18, lo: 10, c: 'cloudy' },
          { d: 'tue', hi: 16, lo: 8, c: 'rainy' },
          { d: 'wed', hi: 20, lo: 9, c: 'sunny' },
        ],
      },
    },
    'person.raymond_du': { s: 'home', ago: 184 },
    'person.ai_q_huang': { s: 'home', ago: 70 },
    'person.vinh_du': { s: 'not_home', ago: 95, a: { zone: 'Away' } },
    'sensor.primo_5_0_1_1_ac_power': { s: '1620' },
    'sensor.primo_5_0_1_1_energy_day': { s: '14.2' },
    'binary_sensor.casa_solar_online': { s: 'on' },
    'sensor.powerpal_gateway_powerpal_power': { s: '380' },
    'sensor.powerpal_gateway_powerpal_daily_energy': { s: '6.1' },
    'sensor.living_room_living_hue_hue_sensor_temperature': { s: '21.4' },
    'sensor.living_room_living_room_temperature': { s: '20.8' },
    'sensor.bedroom_motion_sensor_temperature': { s: '23.2' },
    'climate.bedroom_parents_room_ac': { s: 'off', a: { current: 23.2, target: 22, mode: 'off' } },
    'fan.living_room_air_purifier': { s: 'on', a: { speed: 'medium' } },
    'light.living_room': { s: 'on', a: { brightness: 89, color: 'warm white' }, ago: 41 },
    'light.dining': { s: 'on', a: { brightness: 62, color: 'warm white' }, ago: 18 },
    'light.bedroom_nightlight': { s: 'on', a: { brightness: 30 }, ago: 12 },
    'sensor.front_door_battery': { s: '12' },
    'sensor.tapo_c425_north_wall_battery': { s: 'unknown' },
    'input_boolean.elec_bill_paid': { s: 'off' },
    'input_boolean.gas_bill_paid': { s: 'on' },
    'input_boolean.council_rate_paid': { s: 'on' },
    'input_boolean.car_insurance_paid': { s: 'on' },
    'camera.front_door_live_view': { s: 'idle' },
    'camera.smart_pet_feeder': { s: 'idle' },
    'camera.tapo_c420_south_wall_hd_stream_direct': { s: 'idle' },
    'camera.tapo_c420_east_wall_hd_stream_direct': { s: 'unavailable' },
    'camera.tapo_c200_stockroom_hd_stream_direct': { s: 'unavailable' },
    'camera.tapo_c425_north_wall_hd_stream_direct': { s: 'unknown' },
    'binary_sensor.f_contact_sensor_door': { s: 'unavailable' },
    'binary_sensor.b_contact_sensor_door': { s: 'unavailable' },
    'binary_sensor.m_contact_sensor_door': { s: 'unavailable' },
  },
};
