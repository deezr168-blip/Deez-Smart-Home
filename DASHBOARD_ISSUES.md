...
| BILING-RESID | S4 | `people-locations`, `ipad-command-center`, `home` Energy tile | Closes REG-004/005/006: the "at home" branch of the per-person markdown loop, the WAN chip's unavailable fallback, and the Energy tile's offline fallback were the last three bare-English fragments left over from the UI-012 -> UI-028 -> UI-029 bilingual sequence. | pending stamp | FIXED — AWAITING LIVE VERIFICATION |
